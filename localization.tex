...
first statement follows from Lemmas \ref{T_preserves_psdoker}
and \ref{T_preserves_monos}. For cokernels, notice the ``dual''
of the arguments also hold by Lemma \ref{lemma_2_9_dual}.
\end{proof}
