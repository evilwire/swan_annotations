...
$f: A \to B$, and complete the square into commuting s.e.s's:
\[
\begin{diagram}
...
\end{diagram}
\]
Via universal property of $P$, via $B \to C$ and $L \stackrel{0}{\to} 
C$, lift $C'$ to $C$ and show that $C \simeq C'$, so $C' \in \Cat{C}$.
Finish by splitting the bottom s.e.s. using (2).
\end{proof}
